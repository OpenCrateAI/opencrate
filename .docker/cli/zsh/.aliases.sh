...
alias py='clear && python3.13'
alias pyi='python3.13 -m pip install'
alias pyinc='python3.13 -m pip install --no-cache-dir'
alias pyup='python3.13 -m pip install --upgrade'
alias pyun='python3.13 -m pip uninstall'
alias pyupip='python3.13 -m pip install --upgrade pip'
alias pyvc='python3.13 -m venv .venv && source .venv/bin/activate && pyupip'
alias pyva='source .venv/bin/activate'
alias pyf='python3.13 -m pip freeze'
alias pyfr='python3.13 -m pip freeze > requirements.txt'
